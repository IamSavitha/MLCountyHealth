...
A comprehensive ML analysis dashboard covering:
- Data Overview & EDA
...
# =============================================================================
    ...
    with tab1:
        ...
        with col1:
            ...
            <p><strong>Pros:</strong> Interpretable, fast</p>
        ...
        with col2:
            ...
            <p><strong>Pros:</strong> Reduces overfitting</p>
            <p><strong>Cons:</strong> Keeps all features</p>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col3:
            ...
            <p><strong>Goal:</strong> OLS + sparse solutions</p>
            <p><strong>Equation:</strong> Loss = RSS + α∑|β|</p>
            <p><strong>Parameters:</strong> Coefficients (β)</p>
            <p><strong>Hyperparameters:</strong> α (regularization strength)</p>
            <p><strong>Pros:</strong> Feature selection</p>
            <p><strong>Cons:</strong> May drop important features</p>
            </div>
            """, unsafe_allow_html=True)
...
# =============================================================================
    ...
    for name, model in models.items():
        ...
        if name == 'Logistic Regression':
            ...
            smote_model = KNeighborsClassifier(n_neighbors=5)
        elif name == 'Naive Bayes':
            smote_model = GaussianNB()
        elif name == 'SVM (RBF)':
            smote_model = SVC(kernel='rbf', probability=True)
        elif name == 'Decision Tree':
            smote_model = DecisionTreeClassifier(max_depth=5, random_state=42)
    ...
    with tab1:
        ...
        with col1:
            ...
            <p><strong>Goal:</strong> Linear decision boundary</p>
            <p><strong>Hyperparams:</strong> C (regularization), max_iter</p>
            <p><strong>Pros:</strong> Interpretable, probabilistic</p>
            <p><strong>Cons:</strong> Linear boundaries only</p>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col2:
            ...
            <div class="metric-card">
            <h5>KNN</h5>
            <p><strong>Goal:</strong> Classify by nearest neighbors</p>
            <p><strong>Hyperparams:</strong> k, distance metric</p>
            <p><strong>Pros:</strong> Non-parametric, simple</p>
            <p><strong>Cons:</strong> Slow, curse of dimensionality</p>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col3:
            ...
            <div class="metric-card">
            <h5>Naive Bayes</h5>
            <p><strong>Goal:</strong> Probabilistic (Bayes theorem)</p>
            <p><strong>Hyperparams:</strong> var_smoothing</p>
            <p><strong>Pros:</strong> Fast, works with small data</p>
            <p><strong>Cons:</strong> Assumes independence</p>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col4:
            ...
            <div class="metric-card">
            <h5>SVM</h5>
            <p><strong>Goal:</strong> Maximum margin classifier</p>
            <p><strong>Hyperparams:</strong> C, kernel, gamma</p>
            <p><strong>Pros:</strong> Effective in high dimensions</p>
            <p><strong>Cons:</strong> Slow on large datasets</p>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col1:
            ...
            <div class="metric-card">
            <h5>Decision Tree</h5>
            <p><strong>Goal:</strong> Recursive binary splits</p>
            <p><strong>Hyperparams:</strong> max_depth, min_samples_split</p>
            <p><strong>Pros:</strong> Interpretable, handles non-linear</p>
            <p><strong>Cons:</strong> Overfits easily</p>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col2:
            ...
            <div class="metric-card">
            <h5>Random Forest</h5>
            <p><strong>Goal:</strong> Ensemble of trees (bagging)</p>
            <p><strong>Hyperparams:</strong> n_estimators, max_depth</p>
            <p><strong>Pros:</strong> Robust, feature importance</p>
            <p><strong>Cons:</strong> Less interpretable</p>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col3:
            ...
            <div class="metric-card">
            <h5>Extra Trees</h5>
            <p><strong>Goal:</strong> Extremely randomized trees</p>
            <p><strong>Hyperparams:</strong> n_estimators, max_depth</p>
            <p><strong>Pros:</strong> Faster than RF, reduces variance</p>
            <p><strong>Cons:</strong> Higher bias than RF</p>
            </div>
            """, unsafe_allow_html=True)
...
# =============================================================================
elif page == "5b. Advanced Ensemble Methods (Jane Heng)":
...
# =============================================================================
    ...
    tab1, tab2, tab3, tab4 = st.tabs(["Algorithm Details", "K-Means", "Hierarchical", "Cluster Profiles"])

    with tab1:
        st.markdown("### Clustering Algorithms Overview")
        ...
        with col1:
            ...
            <p><strong>Goal:</strong> Partition data into k clusters minimizing within-cluster variance</p>
            <p><strong>Algorithm:</strong> Iteratively assign points to nearest centroid, update centroids</p>
            <p><strong>Hyperparameters:</strong></p>
            <ul>
            <li><strong>k</strong>: Number of clusters</li>
            <li><strong>init</strong>: Centroid initialization method</li>
            <li><strong>n_init</strong>: Number of initializations</li>
            </ul>
            <p><strong>Pros:</strong> Fast, scalable, easy to interpret</p>
            <p><strong>Cons:</strong> Must specify k, sensitive to outliers, assumes spherical clusters</p>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col2:
            ...
            <p><strong>Goal:</strong> Build nested cluster hierarchy (dendrogram)</p>
            <p><strong>Algorithm:</strong> Start with each point as cluster, merge closest pairs</p>
            <p><strong>Hyperparameters:</strong></p>
            <ul>
            <li><strong>n_clusters</strong>: Number of clusters to extract</li>
            <li><strong>linkage</strong>: Distance between clusters (ward, complete, average)</li>
            </ul>
            <p><strong>Pros:</strong> No need to pre-specify k, produces dendrogram</p>
            <p><strong>Cons:</strong> Slow for large datasets, sensitive to noise</p>
            </div>
            """, unsafe_allow_html=True)
    ...
    with tab3:
        ...
        n_clusters_hier = st.slider("Number of Clusters (Hierarchical)", 2, 10, 5, key='hier')
        agg = AgglomerativeClustering(n_clusters=n_clusters_hier, linkage=linkage_method)
        hier_clusters = agg.fit_predict(X_scaled)

        st.metric("Silhouette Score (Hierarchical)",
                  f"{silhouette_score(X_scaled, hier_clusters):.4f}")

        st.markdown("""
        <div class="insight-box">
        <strong>Dendrogram Interpretation:</strong><br>
        • Height of merge = dissimilarity between clusters<br>
        • Cut horizontally to get desired number of clusters<br>
...
# =============================================================================
    ...
    with col1:
        ...
        **Regression (Obesity Prediction):**
        - Ridge/Lasso perform comparably to OLS
        - R² ~ 0.35-0.40 (moderate fit)
        - Key predictors: Sleep, Drinking, Food Environment

        **Classification (Income Inequality):**
        - Ensemble methods (RF, Extra Trees) perform best
        - F1 Score > 0.70
        - SVM competitive alternative
        """)
