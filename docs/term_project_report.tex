    ...
    \textbf{Savitha Vijayarangan (Team Lead \& Data Integration Specialist):} Conceptualization (Lead), Data Curation (Lead), Investigation (Lead), Software (Lead), Visualization (Lead), Writing - Original Draft (Lead), Writing - Review \& Editing (Lead), Project Administration (Lead)

    \textbf{Jane Heng (Statistical Analyst \& Advanced Ensemble Lead):} Methodology (Equal), Formal Analysis (Equal), Software (Supporting), Validation (Supporting), Writing - Review \& Editing (Supporting)

    \textbf{Rishi Patel (Clustering \& PCA Specialist):} Formal Analysis (Supporting), Software (Supporting), Visualization (Supporting), Investigation (Supporting)

    \textbf{Kapil Kumar (Predictive Modeling \& Visualization Lead):} Software (Supporting), Visualization (Supporting), Formal Analysis (Supporting), Validation (Supporting)
